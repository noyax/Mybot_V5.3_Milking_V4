...
; ageofclash - start
		...
		$lblTrophiesBottomLevel2 = GUICtrlCreateLabel(GetTranslated(99,30, " then take a rest for "), $x + 130, $y+5, -1, 17)
			GUICtrlSetTip(-1, $txtTip)
		$txtTrophiesBottomLevel = GUICtrlCreateInput("0", $x + 85, $y + 1, 40, 18, BitOR($GUI_SS_DEFAULT_INPUT, $ES_CENTER, $ES_NUMBER))
			GUICtrlSetTip(-1, $txtTip)
			GUICtrlSetLimit(-1, 4)
			GUICtrlSetState(-1, $GUI_ENABLE)
		$txtTrophiesPause = GUICtrlCreateInput("15", $x + 265, $y + 1, 30, 18, BitOR($GUI_SS_DEFAULT_INPUT, $ES_CENTER, $ES_NUMBER))
			GUICtrlSetTip(-1, $txtTip)
			GUICtrlSetLimit(-1, 2)
			GUICtrlSetState(-1, $GUI_ENABLE)
		$lblTrophiesPause = GUICtrlCreateLabel(GetTranslated(99,31, " minute(s) "), $x + 300, $y+5, -1, 17)
			GUICtrlSetTip(-1, $txtTip)
; ageofclash - end
